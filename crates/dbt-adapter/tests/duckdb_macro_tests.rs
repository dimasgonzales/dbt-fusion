...
fn duckdb_macro_datediff_file_exists() {
    ...
    let datediff_path = repo_root
        .join("dbt-loader/src/dbt_macro_assets/dbt-duckdb/macros/utils/datediff.sql");
...
fn duckdb_macro_dateadd_file_exists() {
    ...
    let repo_root = PathBuf::from(env!("CARGO_MANIFEST_DIR"))
        ...
        .unwrap()
        .to_path_buf();
    let dateadd_path = repo_root
        .join("dbt-loader/src/dbt_macro_assets/dbt-duckdb/macros/utils/dateadd.sql");
...
fn duckdb_macro_adapters_contains_create_table_as() {
    ...
    let adapters_path = repo_root
        .join("dbt-loader/src/dbt_macro_assets/dbt-duckdb/macros/adapters.sql");
...
fn duckdb_macro_seed_file_exists() {
    ...
    let repo_root = PathBuf::from(env!("CARGO_MANIFEST_DIR"))
        ...
        .unwrap()
        .to_path_buf();
    let seed_path = repo_root
        .join("dbt-loader/src/dbt_macro_assets/dbt-duckdb/macros/seed.sql");
